...
function App() {
  ...
  return (
    <>
    <div className='w-100 h-screen gap-8 flex flex-col items-center py-28' id='main-app-container'>
      <div className='text-center'>
        <h1 className='text-2xl font-bold'>Create Short URLs</h1>
        <p>Making URLs shorter with just one click.</p>
      </div>
      ...
      <TableContainer component={Paper} className='table rounded-md' id="main-table">
